...
#    Updated: 2021/03/23 11:36:00 by vfurmane         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

SRCS		= $(addprefix srcs/, bmp.c canvas.c check_args.c check_ato.c check_color.c check_strto.c color.c free.c get_next_line.c get_next_line_utils.c handle_scene.c handle_shape.c init.c light.c main.c matrix_formula.c mlx_event.c my_mlx.c new_scene.c new_shape.c parameters.c primitives.c proceed.c put.c raytrace.c render.c strto.c vectors_calcul.c vector_double_calcul.c vectors_formula.c \
			  ...
			  $(addprefix primitives/, cylinder.c plane.c sphere.c square.c triangle.c))
OBJS		= $(SRCS:.c=.o)
