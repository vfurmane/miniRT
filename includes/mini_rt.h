...
void			ft_add_pixel_to_bmp(t_buffer *buffer, int color,
					int end_of_line);
...
void			ft_free_mlx(void *mlx, void *win, t_mlx_data *img,
					t_camera *camera);
...
void			my_mlx_put_pixel(t_mlx_data *data, t_pixel pixel,
					int pixel_size, t_scene scene);
...
int				ft_proceed_all_cameras(t_scene *scene, t_buffer *buffer,
								char **argv);
...
int				ft_render_scene(t_scene *scene, t_camera *camera,
					t_buffer *buffer, t_mlx_data *img);
int				ft_proceed_all_cameras(t_scene *scene, t_buffer *buffer,
					char **argv);
void			ft_proceed_window(t_scene *scene);
